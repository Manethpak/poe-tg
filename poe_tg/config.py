...
if not POE_API_KEY:
    logger.error(
        "POE_API_KEY not found in environment variables. Please set it in your environment or .env file."
    )

if not TELEGRAM_TOKEN:
    logger.error(
        "TELEGRAM_TOKEN not found in environment variables. Please set it in your environment or .env file."
    )
